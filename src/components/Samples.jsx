...
const Samples = () =>{
    return (
        ...
        <div className='content' id='Samples'>
            ...
            <h1>* * *</h1>
            <h2>Tabloid Filter - News Server Front-End</h2>
            ...
            <p>Tabloid Filter was my front end project and one of the last big pieces of solo work I did for the bootcamp before our final project as a team. This was the project where I really started to find my feet with software development, and gain a little more confidence with making more ambitious choices. I was particularly pleased with choices made around displaying comments and hiding articles while the comment is displayed so that the styling remained clean and presentable on mobile.</p>
            <a href='https://github.com/OwenPortfolio/FE-nc-news'>Check out the github repo.</a>
            <p></p>
            <a href='https://tabloid-filter.herokuapp.com/'>Explore the test implementation hosted on Heroku</a>
            <h1>* * *</h1>
            <h2>Lights Owen</h2>
